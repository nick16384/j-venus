...
public class ANSI extends JTextPane {
  ...
  public void append(Color c, String s) throws BadLocationException {
	    ...
	    catch (Exception e) {e.printStackTrace();append(c, s);} //Original: BadLocationException
	}
...
// now we have the color, send text that is in that color (up to next escape)
  ...
  public Color getANSIColor(String ANSIColor) {
	  if (!ANSIColor.equals("\u001B[0m")) {
		  sys.log("ANSI", 0, "Requesting ANSI color: " + ANSIColor + "===" + "\u001B[0m");
	  }
