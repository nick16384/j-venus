...
public class Cipher_Decrypt {
	public static String decrypt(String[] reqParams, String[] optParams) {
		if ((reqParams == null) || (reqParams.length != 3)) {
			System.err.println("INTERN.CIPHER.DECRYPT: reqParam Parse error");
			return "reqParamParseError";
		}
		File ciphertextFile = new File(reqParams[1]);
		File keyFile = new File(reqParams[2]);
		String ciphertext = "";
		String key = "";
		...
		String plaintext = "";
		if (reqParams[0].equalsIgnoreCase("shift2c")) {
			//====================================SHIFT2C PREPARATION====================================
