...
//Modified in line 56 + 57 : Does not highlight protected text anymore
/**
...
class ProtectedHighlighter extends DefaultHighlighter
{
	...
	public ProtectedHighlighter(JTextComponent component, Color highlightColor)
	{
		...
		if (highlightColor == null)
		{
			...
			//Do not highlight protected text (highlight with black -> backgroud color, invisible)
			highlightColor = new Color(0, 0, 0); //red, green, blue by default
		}
