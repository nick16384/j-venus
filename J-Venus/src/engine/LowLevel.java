...
/**
 * The intention of this class is to handle low level system tasks, but currently does not
 *  have any implemented. Maybe, some use cases will be found later.
 * @author nick16384
 * @deprecated Class is mostly not used. It was designed to do low level system tasks, but
 *  currently does not have any use. This class is not to be deleted though, because those
 *  tasks might be implemented in a later stage.
 *  @since unknown
 */

@Deprecated
class LowLevel {
	private final byte privLvl = 0; //Privilege Level: Increase means more permissions. OS Dependend, Max: 5. Not implemented
